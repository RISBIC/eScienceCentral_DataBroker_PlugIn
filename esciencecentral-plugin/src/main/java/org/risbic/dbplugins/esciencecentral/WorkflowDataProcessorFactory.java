...
public class WorkflowDataProcessorFactory implements DataFlowNodeFactory
{
    public WorkflowDataProcessorFactory(String name, Map<String, String> properties)
    {
        _name       = name;
        ...
        throws InvalidClassException, InvalidMetaPropertyException, MissingMetaPropertyException
    {
        ...
        propertyNames.add(WorkflowDataProcessor.SERVERHOST_PROPERTYNAME);
        propertyNames.add(WorkflowDataProcessor.SERVERPORT_PROPERTYNAME);
        propertyNames.add(WorkflowDataProcessor.USERNAME_PROPERTYNAME);
        propertyNames.add(WorkflowDataProcessor.USERPASSWORD_PROPERTYNAME);
        propertyNames.add(WorkflowDataProcessor.WORKFLOWNAME_PROPERTYNAME);
        propertyNames.add(WorkflowDataProcessor.RESULTSFILENAME_PROPERTYNAME);
        ...
        throws InvalidNameException, InvalidPropertyException, MissingPropertyException
    {
        if (dataFlowNodeClass.isAssignableFrom(WorkflowDataProcessor.class))
            return (T) new WorkflowDataProcessor(name, properties);
        else
            return null;
    }
